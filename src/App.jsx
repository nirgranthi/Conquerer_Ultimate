          ...
          <div className="relative">
            ...
            <div className="radio-input">
              <label className="label">
                <input value="easy" name="value-radio" id="value-1" type="radio" />
                <span className="text">Easy</span>
              </label>
              <label className="label">
                <input selected value="medium" name="value-radio" id="value-2" type="radio" checked />
                <span className="text">Medium</span>
              </label>
              <label className="label">
                <input value="hard" name="value-radio" id="value-3" type="radio" />
      ...
      <div className="tooltip-container">
        ...
        <div className="tooltip-content">
          <div className="social-icons">
            <a href="https://twitter.com/intent/tweet?url=https://nirgranthi.github.io/Conquerer_Ultimate/" target="_blank" className="social-icon twitter">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="24"
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u=https://nirgranthi.github.io/Conquerer_Ultimate/" target="_blank" className="social-icon facebook">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="24"
            ...
            <a href="https://wa.me/?text=https://nirgranthi.github.io/Conquerer_Ultimate/" target="_blank" className="social-icon whatsapp">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
